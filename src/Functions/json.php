 ...
 * @param int   $options Bitmask consisting of constants described on the JSON constants page.
 ...
 *
 * @param mixed $value A value to test when building a JSON string.
 *
 * @return mixed
 */
